...
namespace UnityChan
{
	public class AutoBlink : MonoBehaviour
	{
		...
		void SetCloseEyes ()
		{
			...
			{
				ref_SMR_EYE_DEF.SetBlendShapeWeight(indexCloseEyes, ratio_Close);
			}
		...
		void SetHalfCloseEyes ()
		{
            if (ref_SMR_EYE_DEF != null)
            {
                ref_SMR_EYE_DEF.SetBlendShapeWeight (indexCloseEyes, ratio_HalfClose);
            }
            if (ref_SMR_EL_DEF != null)
            {
		...
		void SetOpenEyes ()
		{
            if (ref_SMR_EYE_DEF != null)
            {
                ref_SMR_EYE_DEF.SetBlendShapeWeight (indexCloseEyes, ratio_Open);
            }
            if (ref_SMR_EL_DEF != null)
            {
