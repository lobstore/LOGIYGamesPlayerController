...
namespace LOGIYGames
{
    ...
    public class SensorsModule : MonoModuleBase
    {
        ...
        private void PerformDetection()
        {
            ...
            // Wall detection
            IsObstacleLegsRight = Physics.Raycast(detectionOrigin, characterController.transform.right, out legsLeftHit, rayDistance, includeLayers);
            ...
            IsObstacleLegsFront = Physics.Raycast(detectionOrigin, characterController.transform.forward, out legsLeftHit, rayDistance, includeLayers);
