...
namespace LOGIYGames
{
    public class SaveSlotPresenter : IDisposable
    {
        ...
        private void OnSlotClicked()
        {
            if (isForLoadingData)
            {
                //DataPersistenceManager.Instance.ChangeSelectedProfileId(saveSlotModel.SlotId.ToString());
        ...
        private void OnClearSlotClicked()
        {
           ...
           // DataPersistenceManager.Instance.DeleteProfileData(saveSlotModel.SlotId.ToString());
